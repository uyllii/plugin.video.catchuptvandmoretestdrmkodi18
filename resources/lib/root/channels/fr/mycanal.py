...
URL_LIVES_DRM = {
    'c8': 'https://hss-m002-live-aka-canalplus.akamaized.net/live/disk/c8-hd/hddvr.isml/manifest?token={0}',
    'cstar': 'https://hss-m001-live-aka-canalplus.akamaized.net/live/disk/cstar-hd/hddvr.isml/manifest?token={0}',
    'canalplus': 'https://hss-m001-live-aka-canalplus.akamaized.net/live/disk/canalplusclair-hd/hd-clair.isml/manifest?token={0}',
    'infosportplus': 'https://hss-m005-live-aka-canalplus.akamaized.net/live/disk/infosportplus-hd/hd.isml/manifest?token={0}'
}
...
def start_live_tv_stream(params):
    params['next'] = 'play_l'
    params['live_manifest'] = URL_LIVES_DRM[params.channel_name]
    return get_video_url(params)
