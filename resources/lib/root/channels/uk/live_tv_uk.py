...
def build_live_tv_menu(params):
    ...
    for index, (channel_order, channel_name, channel_path) in enumerate(menu):
        ...
        if params.channel_name == 'questtv' or \
            params.channel_name == 'questred':

            if params.channel_name == 'questtv':
                live_html = utils.get_webcontent(URL_LIVE % 'quest')
            elif params.channel_name == 'questred':
                live_html = utils.get_webcontent(URL_LIVE % 'quest-red')
